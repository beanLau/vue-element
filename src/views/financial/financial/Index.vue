      ...
      >
        ...
        >
          <el-table-column
            ...
            align="center"
          ></el-table-column>
          <el-table-column prop="title" label="月分" align="center">
          </el-table-column>
          <el-table-column prop="title" label="合作方式" align="center">
          </el-table-column>
          <el-table-column prop="title" label="分帐比例" align="center">
          </el-table-column>
          <el-table-column prop="sysClassName" label="销售金额" align="center">
          </el-table-column>
          <el-table-column
            prop="teacherNames"
            label="分帐金额"
